...
@FindBy(css = "div:nth-child(2) div.css-12xi1o5 main.css-1lri2aw div.css-4ibs1k > div.Toastify")
WebElement existingEmail;
    public RegistrationPage verifyExistingEmailErrorMessage() {
        Assert.assertTrue(existingEmail.getText().contains("Registration failed. Request failed with status code 403"));
        return this;
    }
